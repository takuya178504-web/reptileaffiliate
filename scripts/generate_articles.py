...
KEYWORDS = [
    # レオパ系
    "レオパードゲッコー ケージ", "レオパ 床材", "レオパ シェルター",
    "レオパ 水入れ", "レオパ カルシウムパウダー", "レオパ 餌 コオロギ",
    "レオパ ウェットシェルター", "レオパ 温度管理", "レオパ 脱皮 補助",
    "レオパ 初心者 飼育セット", "レオパ ハンドリング 慣らし方",
    "ヒョウモントカゲモドキ ケージ おすすめ", "ヒョウモントカゲモドキ 餌",
    # ボールパイソン系
    "ボールパイソン ケージ", "ボールパイソン 飼育セット",
    "ボールパイソン 床材", "ボールパイソン 温度管理",
    "ボールパイソン シェルター", "ボールパイソン 餌 マウス",
    "ボールパイソン 初心者 飼い方",
    # 設備・機器系
    "爬虫類 サーモスタット", "爬虫類 紫外線ライト", "爬虫類 保温球",
    "爬虫類 温度計 湿度計", "爬虫類 ケージ おすすめ",
    "爬虫類 パネルヒーター", "爬虫類 霧吹き 自動",
    "爬虫類 暖突 使い方", "爬虫類 ライト タイマー",
    # ピンセット・道具系
    "爬虫類 ピンセット", "爬虫類 掃除 道具", "爬虫類 消臭スプレー",
    # コーンスネーク系
    "コーンスネーク 飼育セット", "コーンスネーク ケージ",
    "コーンスネーク 床材", "コーンスネーク 餌",
    # フトアゴ系
    "フトアゴヒゲトカゲ ケージ", "フトアゴヒゲトカゲ 餌",
    "フトアゴヒゲトカゲ 紫外線ライト", "フトアゴヒゲトカゲ 飼育セット",
    # クレステッドゲッコー系
    "クレステッドゲッコー ケージ", "クレステッドゲッコー 餌",
    "クレステッドゲッコー 飼育 初心者",
    # ヤモリ系
    "ニシアフリカトカゲモドキ 飼育", "ガーゴイルゲッコー 飼育",
    # 総合
    "爬虫類 飼育 初心者 おすすめ", "爬虫類 冬 保温 対策",
    "爬虫類 夏 冷却 対策", "爬虫類 餌 保存 方法",
]
...
def main():
    ...
    if not remaining:
        print("全キーワード完了。新しいキーワードを追加してください。")
        return
    ...
    print(f"完了! {len(new_articles)}記事を生成しました。残り{len(remaining)-len(new_articles)}キーワード。")
